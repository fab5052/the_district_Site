...
<a href="view_index_cat.php" class="nav-icon justify-items-center" aria-label="homepage" aria-current="page">
        ...
        <a class="nav-link " href="view_index_cat.php" aria-current="page">Accueil</a>
