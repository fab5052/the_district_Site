...
if (in_array($Currentpage, $array_index)) {
    ...
    $plat_index->execute();
    $plats_view_index = $plat_index->fetchAll(PDO::FETCH_CLASS | PDO::FETCH_PROPS_LATE, "Plat");
...
// Récupération des catégories pour la page de catégorie
$cat_page->execute();
$categories = $cat_page->fetchAll(PDO::FETCH_CLASS | PDO::FETCH_PROPS_LATE, "Categorie");


   
// Affichage des catégories sur la page de catégorie
