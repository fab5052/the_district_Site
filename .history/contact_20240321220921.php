...
<fieldset >
  ...
  <div class="container d-block justify-content-center position-relative ">
    <div class="row ">
     
 <form method="POST" name="inscription" id="validationCustom" class="flex-row needs-validation " novalidate>

        <div class="col-md-6 ">
       <span>   <label for="validationCustom" class="form-label">Prénom</label></span>
          <input type="text" class="form-control" id="validationCustom" placeholder="Jean" required>
        ...
        <div class="col-md-6 ">     
          ...
          <input type="text" class="form-control" id="validationCustom" placeholder="Durand" required>
        </div>
   
     
        <div class="col-md-6 p-3">
          <span><label for="validationCustom" class="form-label">Username</label></span>
          <div class="input-group has-validation">
            <input type="text" class="form-control" id="validationCustom" aria-describedby="inputGroupPrepend"
              required>
            <div class="valid-feedback">Semble correcte!</div>
        ...
        <div class="col-md-6 ">
          ...
          <input type="email" class="form-control" id="validationCustom" aria-describedby="emailHelpId"
        ...
        <div class="col-md-6">
          ...
          <option selected disabled value="">Choisir un sujet...</option>             <option value="produit">Question sur un produit</option>
        ...
        <div class="col-md-6">
          ...
          <textarea class="form-label" name="question" id="question" placeholder="* Maximum 50 caractères"
            required></textarea>
